 ...
 * @author Enis
 */
public class WrongNotification extends javax.swing.JFrame {

    /**
     * Creates new form WrongNotification
     */
    public WrongNotification() {
        initComponents();
        setAlwaysOnTop(true);
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(244, 66, 54));

        messageLabel.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        messageLabel.setForeground(new java.awt.Color(255, 255, 255));
        messageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons Folder/icons8-cancel-96.png"))); // NOI18N
