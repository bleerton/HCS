 ...
 * @author bleer
 */
public class PatientReports extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        therapyDateComboBox = new javax.swing.JComboBox<>();
        ...
        therapyDateComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                therapyDateComboBoxActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(therapyDateComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 377, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(therapyDateComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel22))
                        .addGap(18, 18, 18)
                        .addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void therapyDateComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_therapyDateComboBoxActionPerformed
    ...
    }//GEN-LAST:event_therapyDateComboBoxActionPerformed

    private void loadLabels() throws HealthException {
        if (!hasReports()) {
        ...
        try {
            Report p = (Report) therapyDateComboBox.getSelectedItem();
            patientIDText.setText(p.getPatientID() + "");
            patientNameText.setText(p.getPatientID().getFirstName());
            patientLastNameText.setText(p.getPatientID().getLastName());
            parentNameText.setText(p.getPatientID().getParentName());
            patientAddressText.setText(p.getPatientID().getAddress());
            if (p.getPatientID().getSex().equalsIgnoreCase("Female")) {
                femaleButton.setSelected(true);
                maleButton.setSelected(false);
            } else {
                maleButton.setSelected(true);
            ...
            doctorIDText.setText(p.getDoctorID() + "");
            doctorLastName.setText(p.getDoctorID().getLastName());
            doctorNameText.setText(p.getDoctorID().getFirstName());
            doctorPhoneNumberText.setText(p.getDoctorID().getPhoneNumber());
            cityText.setText(p.getCity());
            codeText.setText(p.getCode()+"");
            if (p.getInstitution().equalsIgnoreCase("Public")) {
            ...
            diagnosisText.setText(p.getDiagnose());
    ...
    public boolean hasReports() throws HealthException{
        ...
        for (int i = 0; i < reports.size(); i++) {
                if (reports.get(i).getPatientID().getPatientID() == this.getPatientIDTable()) {
                    return true;
                }
            }
        return false;
    ...
    private javax.swing.JComboBox<String> therapyDateComboBox;
